...
export const createUserDocumentFromAuth_Seller = async (
    userAuth,
...
export const createAuthUserWithEmailAndPassword_Seller = async (
    email,
    password
) => {
...
export const signInAuthUserWithEmailAndPassword_Seller = async (
    email,
    password
) => {
    if (!email || !password) return
